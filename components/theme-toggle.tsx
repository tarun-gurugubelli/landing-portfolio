...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="relative h-10 w-10 rounded-full border-2 border-gray-300 dark:border-gray-600 hover:border-gray-900 dark:hover:border-gray-300 transition-all duration-300"
    >
